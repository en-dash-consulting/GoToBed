...
| Title | Status |
|-------|--------|
| [Fix structural in global: No automated enforcement of cross-zone layering exists: the architectural bounda (+2 more)](./fix-structural-in-global-no-8967fb.md) | pending |
