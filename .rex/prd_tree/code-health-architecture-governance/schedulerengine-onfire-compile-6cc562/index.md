...
level: "feature"
title: "SchedulerEngine.onFire compile-time contract"
status: "completed"
priority: "high"
source: "sourcevision"
...
| Title | Status |
|-------|--------|
| [Require onFire handler at SchedulerEngine init (non-optional closure)](./require-onfire-handler-at-89e673.md) | completed |
