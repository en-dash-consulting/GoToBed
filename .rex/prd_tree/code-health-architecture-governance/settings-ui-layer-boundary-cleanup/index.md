...
level: "feature"
title: "Settings UI layer-boundary cleanup"
status: "completed"
priority: "high"
source: "sourcevision"
...
| Title | Status |
|-------|--------|
| [Move Palette and window controller to proper layers, route store writes through AppEnvironment](./move-palette-and-window-b8afc2.md) | completed |
