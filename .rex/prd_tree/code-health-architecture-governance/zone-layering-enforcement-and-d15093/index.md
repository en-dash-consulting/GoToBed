...
level: "feature"
title: "Zone-layering enforcement and event-chain testing"
status: "completed"
priority: "high"
source: "sourcevision"
...
| Title | Status |
|-------|--------|
| [Add zone-layering check script and wire into validate/CI](./add-zone-layering-check-script-8967fb.md) | completed |
